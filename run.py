...
def main():
    ...
    train_dataset = POIDataset(data_filename="datasets/{}/train_poi_zero.pkl".format(args.dataset),
    ...
    test_dataset = POIDataset(data_filename="datasets/{}/test_poi_zero.pkl".format(args.dataset),
                              pois_coos_filename="datasets/{}/{}_pois_coos_poi_zero.pkl".format(args.dataset, args.dataset),
                              num_users=NUM_USERS,
                              num_pois=NUM_POIS,
                              padding_idx=PADDING_IDX,
